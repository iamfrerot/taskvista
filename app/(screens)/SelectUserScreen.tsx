    ...
    const fetchUsers = async () => {
      ...
      try {
        ...
        const response = await axios.get(
          "http://167.99.192.166:4000/api/v1/users/view",
          {
            headers: {
  ...
  const createOrNavigateChat = async (user: User) => {
    try {
      ...
      const checkChatResponse = await axios.get(
        `http://167.99.192.166:4000/api/v1/chats/check/${userId}/${user._id}`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
            "Content-Type": "application/json",
      ...
      if (checkChatResponse.data.exists) {
        ...
        const response = await axios.post(
          "http://167.99.192.166:4000/api/v1/chats/create-individual",
          {
