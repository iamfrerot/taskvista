...
const Account = () => {
  ...
  const getUser = async () => {
    try {
      ...
      const response = await fetch(
        `http://167.99.192.166:4000/api/v1/users/view/${userId}`,
        {
          headers: {
  ...
  const handleUpdateProfile = async () => {
    ...
    try {
      const response = await fetch(
        `http://167.99.192.166:4000/api/v1/users/edit/${userId}`,
        {
          method: "PATCH",
          headers: {
            Authorization: `Bearer ${token}`,
  ...
  const handleChangePassword = async () => {
    ...
    try {
      const response = await fetch(
        `http://167.99.192.166:4000/api/v1/users/change-password/${userId}`,
        {
          method: "POST",
          headers: {
            Authorization: `Bearer ${token}`,
