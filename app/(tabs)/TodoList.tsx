...
const TodoList = () => {
    ...
    const fetchTodos = async () => {
      ...
      try {
        const response = await axios.get(
          "http://167.99.192.166:4000/api/v1/todo/my-todos",
          {
            headers: {
  ...
  const handleAddTodo = async () => {
    ...
    try {
      ...
      const response = await axios.post(
        "http://167.99.192.166:4000/api/v1/todo/create",
        {
          ...newTodo,
  ...
  const handleCompleteTodo = async (_id: string) => {
    ...
    try {
      ...
      const response = await axios.patch(
        `http://167.99.192.166:4000/api/v1/todo/complete/${_id}`,
        {},
        {
          headers: {
            Authorization: `Bearer ${token}`,
  ...
  const handleDeleteTodo = async (_id: string) => {
    ...
    try {
      await axios.delete(
        `http://167.99.192.166:4000/api/v1/todo/delete/${_id}`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
            "Content-Type": "application/json",
  ...
  const handleEditTodo = async () => {
    ...
    try {
      const response = await axios.patch(
        `http://167.99.192.166:4000/api/v1/todo/edit/${selectedTodo._id}`,
        {
          ...selectedTodo,
          deadline:
            selectedDate ||
